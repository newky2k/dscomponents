...
using DSComponentsSampleMac.Views;
...
namespace DSComponentsSampleMac.Data.Grid
{
	...
	public class ExampleDataTable : DSDataTable
	{
		...
		private NSImage[] mIcons;
		//private bool isUpSort;
		//		private List<DSDataRow> mRows = new List<DSDataRow> ();

		private NSImage[] Icons {
			get
			{
				if (mIcons == null)
				{

					mIcons = new NSImage[] { new NSImage("first.png"), new NSImage("second.png") };
				}
